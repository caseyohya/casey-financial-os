...
import { generateScheduleEExport } from "@/lib/utils/exports";
import type { Property, PropertyExpense, PropertyIncome } from "@/lib/types/real-estate";
...
export async function GET(request: Request) {
  ...
  const csv = generateScheduleEExport(
  ...
  return new NextResponse(csv, {
    headers: {
      ...
      "Content-Disposition": `attachment; filename="schedule-e-${year}.csv"`,
    },
  });
}
